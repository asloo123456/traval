<template>
  <div id="myLogin">
    ...
    <div class="center">
      <div>
        <div class="vw-main">
          <input class="myInput1" placeholder="请输入您的手机号" v-model="phone" v-focus @keydown.13="login">
          <input class="myInput2" placeholder="请输入您的密码" v-model="upwd" @keydown.13="login">
